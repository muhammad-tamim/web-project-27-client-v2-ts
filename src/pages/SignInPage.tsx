                    ...
                    <form>
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input name="email" type="email" required className="w-full text-slate-900 text-sm border-b border-slate-300 focus:border-[#f89223] pl-2 pr-8 py-3 outline-none" placeholder="Enter email" />
                        ...
                        <div className="mt-8">
                            ...
                            <div className="relative flex items-center">
                                <input name="password" type="password" required className="w-full text-slate-900 text-sm border-b border-slate-300 focus:border-[#f89223] pl-2 pr-8 py-3 outline-none" placeholder="Enter password" />
                        ...
                        <div className="mt-8 text-right">
                            <button className="text-[#f89223] font-medium text-sm hover:underline">
                                Forgot Password?
                            </button>
                        </div>

                        <div className="mt-12">
                            <button className="btn w-full text-white bg-[#f89223]">
                                Sign in
                            </button>
                        </div>
