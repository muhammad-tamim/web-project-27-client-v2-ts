        ...
        <div className='py-10 lg:py-20'>
            <div
                ...
                <div className="rounded-t-lg h-32 overflow-hidden">
                    <img className="object-cover object-top w-full" src='https://tinyurl.com/4kurr728' alt='Mountain' />
                </div>
                ...
                <div className="p-4 border-t mx-8 mt-2">
                    <button className="w-1/2 block mx-auto btn rounded-full text-white bg-[#f89223]">Follow</button>
                </div>
            </div>
        </div>
    );
